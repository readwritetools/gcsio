...
export function parseTae(e, r, t) {
    return expect(r, 'String'), expect(t, 'Object'), new StringEncodedParser(e, 'tae').parse(r);
}
...
export function parseTaeBinary(e, r, t) {
    return expect(r, 'ArrayBuffer'), expect(t, 'Object'), new ByteEncodedParser(e, 'taebin').parse(r);
}